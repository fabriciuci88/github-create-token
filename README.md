...
*	If a `username` is __not__ provided, the implementation will attempt to infer a username by executing `git config user.name` in the current working directory.
